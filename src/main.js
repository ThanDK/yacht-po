...
function initKeyboardNav() {
    document.addEventListener('keydown', (e) => {
        if (e.key === 'ArrowRight') {
            yachtData.merry.currentIndex = (yachtData.merry.currentIndex + 1) % yachtData.merry.images.length;
            yachtData.camarat.currentIndex = (yachtData.camarat.currentIndex + 1) % yachtData.camarat.images.length;
            ...
            yachtData.merry.currentIndex = (yachtData.merry.currentIndex - 1 + yachtData.merry.images.length) % yachtData.merry.images.length;
            yachtData.camarat.currentIndex = (yachtData.camarat.currentIndex - 1 + yachtData.camarat.images.length) % yachtData.camarat.images.length;
        }
    });
}
